package com.apps.nenad.nfcinfowriter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maintTextView = (TextView)findViewById(R.id.textView);

        Typeface faceFutura = Typeface.createFromAsset(getAssets(),
                "fonts/futura_bold.ttf");
        mainEditText.setTypeface(faceFutura);
        maintTextView.setTypeface(faceFutura);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.hasExtra(NfcAdapter.EXTRA_TAG)) {
            ...
            NdefMessage ndefMessage = createNdefMessage(mainEditText.getText() + "");
